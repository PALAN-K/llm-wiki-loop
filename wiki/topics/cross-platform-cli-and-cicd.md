...
> Raw: [Note](../../raw/notes/2026-08-16-cli-architecture-and-cicd-matrix.md)
...
2. **Stage 2 (Isolated Tests)**: Sandboxed E2E testing using `tempfile.TemporaryDirectory` to prevent circular dependencies.
