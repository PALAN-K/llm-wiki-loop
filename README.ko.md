...
<p align="center">
  <b>🌏 언어:</b> <a href="README.md">🇺🇸 English</a> • <a href="README.ja.md">🇯🇵 日本語</a> • <a href="README.ko.md">🇰🇷 한국어</a> &nbsp;|&nbsp; <b>🌐 라이브 데모:</b> <a href="https://palan-k.github.io/llm-wiki-loop/">EN</a> • <a href="https://palan-k.github.io/llm-wiki-loop/ja/">JA</a> • <a href="https://palan-k.github.io/llm-wiki-loop/ko/">KO</a> &nbsp;|&nbsp; <i>Zero-DB • 100% Markdown • 7개 에이전트 • 25개 테스트 • v1.3.2</i>
</p>
...
<p align="center">
  <img src="docs/assets/commit-gate.gif" alt="Commit gate — 0 errors, index/log 함께" width="860" /><br>
  <b>A. Commit Gate</b><br><sub>git commit → <code>check_evidence 0 errors</code> → <code>index.md+log.md</code> 함께 업데이트</sub>
</p>

<p align="center">
  <img src="docs/assets/drift-detection.gif" alt="Drift detection — 0.01초" width="860" /><br>
  <b>B. Drift Detection</b><br><sub>코드 수정 → <code>git diff</code> 0.01초 → <code>Status: Outdated</code></sub>
</p>

<p align="center">
  <img src="docs/assets/skill-evolution.gif" alt="Skill evolution — 2회 → scan:skills" width="860" /><br>
  <b>C. Skill Evolution</b><br><sub><code>log.md</code> 2회 반복 → <code>scan:skills</code> → <code>.agents/skills/</code></sub>
</p>

<p align="center">
  <img src="docs/assets/multi-agent.gif" alt="Multi-agent — 7 에이전트" width="860" /><br>
